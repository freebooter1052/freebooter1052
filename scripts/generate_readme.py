...
def generate_stats_content(github_username, leetcode_username, github_api_ok=True):
    ...
    if github_api_ok:
        github_stats_section = f"""<div align="center">
  <table>
    <tr>
      <td align="center">
...
"""
    ...
    leetcode_stats_section = f"""<div align="center">
  <a href="https://leetcode.com/{leetcode_username}">
    ...
    return f"{github_stats_section}{leetcode_stats_section}".strip("\n")
...
def main():
    ...
    stats_content = generate_stats_content(github_username, leetcode_username, github_api_ok=github_api_ok)
